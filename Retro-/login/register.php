...
<div class="container">
        <div class="row justify-content-center mt-3 m-1">
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                ...
                <form action="login.php" method="POST">
                    ...
                    <div class="form-group text-center mt-3 m-1 ">
                        <h1 class="text-light">Registrarse tututuuu</h1>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group mx-sm-4 pt-1 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
